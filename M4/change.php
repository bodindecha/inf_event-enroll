		...
		<main shrink="<?php echo($_COOKIE['sui_open-nt'])??"false"; ?>">
			<div class="container">
				...
				<?php if (!$permitted) echo '<center class="message red">นักเรียนไม่มีสิทธิ์ยื่นคำร้องขอเปลี่ยนแปลงกลุ่มการเรียน ประเภทห้องเรียนปกติ</center>'; else { ?>
					<center class="message cyan">การยื่นคำร้องขอเปลี่ยนแปลงกลุ่มการเรียน ประเภทห้องเรียนปกติ จากนักเรียนที่จบชั้นมัธยมศึกษาปีที่ 3 ของโรงเรียนเดิม ปีการศึกษา 2565<br><?=$_SESSION['auth']['name']['th']['a']?> กลุ่มการเรียน<u><?=$readstatus["name1"]?></u></center>
					...
					<?php } if ($inTime) { ?>
						...
						<div class="--message gray" name="instruction">
							...
							<ol>
								...
								<li>นักเรียนสามารถยื่นคำร้องของเปลี่ยนแปลงกลุ่มการเรียนผ่านระบบออนไลน์ได้ตั้งแต่วันที่ 8 มีนาคม 2565 เวลา 09.00 น. ถึงวันที่ 10 มีนาคม 2565 เวลา 15.00 น. หากนักเรียนไม่ยื่นคำร้องขอเปลี่ยนแปลงกลุ่มการเรียนโรงเรียนจะจัดให้นักเรียนเรียนกลุ่มการเรียนตามประกาศผลการจัดกลุ่มการเรียน ครั้งที่ 1 ประกาศภายในวันที่ 8 มีนาคม 2565 เวลา 09.00 น.</li>
