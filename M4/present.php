	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				seek_param();
				$('form input[name="usf"]').on("change", function() { prs.validate_file(false); });
			});
			...
			function gainNoti(IDs) {
				const message = [
					...
					[1, "บัณชีผู้ใช้งานท่าน<u>ไม่ใช่ประเภทนักเรียน</u>. กรุณาเข้าสู่ระบบด้วยบัญชีผู้ใช้งานนักเรียน."],
					...
					[2, "ขณะนี้หมดเวลาในการรายงานตัวของนักเรียนแล้ว."],
		...
		<main shrink="<?php echo($_COOKIE['sui_open-nt'])??"false"; ?>">
			<div class="container">
				...
				<?php if (!$permitted) echo '<center class="message red">นักเรียนไม่มีสิทธิ์รายงานตัวเข้าศึกษาต่อ ณ โรงเรียนบดินทรเดชา (สิงห์ สิงหเสนี) ประเภทห้องเรียนปกติ</center>'; else { ?>
					<center class="message cyan">การรายงานตัวเข้าศึกษาต่อ ณ โรงเรียนบดินทรเดชา (สิงห์ สิงหเสนี) ประเภทห้องเรียนปกติ จากนักเรียนที่จบชั้นมัธยมศึกษาปีที่ 3 ของโรงเรียนเดิม ปีการศึกษา 2565<br><?=$_SESSION['auth']['name']['th']['a']?></center>
					<?php if (empty($readstatus['choose'])) { ?>
						<?php if ($inTime) { ?>
							...
							<form class="form message blue" name="rights" method="post" enctype="multipart/form-data" action="/e/enroll/resource/php/api">
								<center>กดปุ่มเพื่อยืนยัน หรือ สละสิทธิ์ เข้าศึกษาต่อ ณ โรงเรียนบดินทรเดชา (สิงห์ สิงหเสนี) ประเภทห้องเรียนปกติ จากนักเรียนที่จบชั้นมัธยมศึกษาปีที่ 3 ของโรงเรียนเดิม ปีการศึกษา 2565</center>
								<fieldset>
								...
								<div class="group spread last" name="decide">
									...
									<button class="last red" onClick="return prs.choose(false)">สละสิทธิ์การเข้าศึกษาต่อ</button>
								</div>
							</form>
						<?php } else { ?>
					...
					<?php } } else { ?>
						...
						<div class="message gray" name="instruction">
							...
							<ol>
								...
								<li>ติดตามผลการจัดกลุ่มการเรียน ครั้งที่ 1 ภายในวันที่ 8 มีนาคม 2565 เวลา 09.00 น. ที่<a href="/go?url=https%3A%2F%2Fbodin.ac.th" target="_blank">เว็บไซต์โรงเรียน</a> หากนักเรียนต้องการเปลี่ยนกลุ่มการเรียน ยื่นคำร้องขอเปลี่ยนแปลงกลุ่มการเรียน ตั้งแต่วันที่ 8 มีนาคม 2565 เวลา 09.00 น. ถึงวันที่ 10 มีนาคม 2565 เวลา 15.00 น. ที่เว็บไซต์ <a href="change">https://inf.bodin.ac.th/e/enroll/M4/change</a></li>
								<li>ยืนยันสิทธิ์เข้าศึกษาต่อ ตั้งแต่วันที่ 12 มีนาคม 2565 เวลา 09.00 น. ถึงวันที่ 15 มีนาคม 2565 เวลา 15.00 น. ที่เว็บไซต์ <a href="confirm">https://inf.bodin.ac.th/e/enroll/M4/confirm</a></li>
								<li>ติดตามผลการจัดกลุ่มการเรียน ครั้งที่ 2  ภายในวันที่ 25 มีนาคม 2565 เวลา 09.00 น. ที่<a href="/go?url=https%3A%2F%2Fbodin.ac.th" target="_blank">เว็บไซต์โรงเรียน</a></li>
								<li>สอบจัดห้องเรียน (เฉพาะกลุ่มการเรียนวิทยาศาสตร์-คณิตศาสตร์ และคณิตศาสตร์-ภาษาอังกฤษ) วันที่ 1 เมษายน 2565 เวลา 09.00 - 12.00 น.</li>
								<li>ศึกษาคำชี้แจงเอกสารประกอบการมอบตัวและกำหนดนัดหมายนักเรียน <a href="/go?url=https%3A%2F%2Fbodin.ac.th%2Fs65%2Fm3-m4%2Ffdoc.pdf" target="_blank">https://bodin.ac.th/s65/m3-m4/fdoc.pdf</a></li>
								<li>มอบตัว วันที่ 3 เมษายน 2565 เวลา 09.00 - 16.30 น.</li>
