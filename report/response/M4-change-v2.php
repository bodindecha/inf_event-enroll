	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				ajax("/e/enroll/resource/php/api", {type: "app", act: "loadFilterOpt", param: "cng"}).then(function(dat) {
			...
			const sD = {
				...
				load: function(change="filter") {
					...
					$.post("/e/enroll/resource/php/response?list=cng&change="+change+(sv.sq!=null?("&q="+encodeURIComponent(sv.sq)):""), {
				...
				<div class="wrapper">
					<div class="group f">
						...
						<div class="dir slider">
							<div class="form">
								<select name="class">
									<option value="*" selected>*นักเรียนที่มีสิทธิ์ทั้งหมด*</option>
