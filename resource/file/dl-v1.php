<?php
	...
	if (isset($_REQUEST["name"])) {
		...
		switch ($file) {
			case "sggtmf":	$type = "jpg"; $dl = false;	$path = "ตัวอย่างใบรับรองผลการสมัครเข้าศึกษาต่อระดับชั้นมัธยมศึกษาปีที่-4"; break;
			...
			case "sef-1n":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียนทั่วไป ม.1"; $pages = 2; break;
			case "sef-1m":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียนคณิต ม.1"; $pages = 2; break;
			# case "sef-1s":	$type = "pdf"; $dl = true;	$path = "2566/ใบมอบตัว ห้องเรียนวิทย์ ม.1"; $pages = 1; break;
			case "sef-1p":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียนวิทย์ สอวน. ม.1"; $pages = 2; break;
			case "sef-1i":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียนวิทย์ สสวท. ม.1"; $pages = 2; break;
			case "sef-4n":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียนทั่วไป ม.4"; $pages = 2; break;
			case "sef-4s":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียนพิเศษ ม.4"; $pages = 2; break;
			case "sef-4d":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียนพสวท ม.4"; $pages = 2; break;
			case "sef-1e":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียน EP ม.1"; $pages = 2; break;
			case "sef-4e":	$type = "pdf"; $dl = true;	$path = "2569/ใบมอบตัว ห้องเรียน EP ม.4"; $pages = 2; break;
			# case "eioad":	$type = "pdf"; $dl = false;	$path = "2569/คำชี้แจงเอกสารการมอบตัว"; $pages = 1; break;
			case "eioad":	$type = "pdf"; $dl = false;	$path = "2569/แนวทางการเข้ามอบตัว ม.4 ห้องเรียน พสวท. 2569"; $pages = 1; break;
	...
	if (!isset($error) && $type == "pdf") {
		...
		for ($pageno = 1; $pageno <= $pages; $pageno++) {
			...
			if (preg_match("/^sef\-(1[nmspie]|4[nsde])$/", $file) && $pageno == 1) { // Write PDF for confirm
