<?php
	...
	$admission = array(
		"year" => "2569",
		"link" => "/go?url=https%3A%2F%2Fbodin.ac.th%2Fhome%2F2026%2F0"
	);
	$APP_PAGE -> print -> head();
?>
<style type="text/css">
...
<main class="bg-rainbow-img">
	<section class="container">
		...
		<p><span class="ref-00001">ติดตามข่าว</span><a target="_blank" href="/go?url=https%3A%2F%2Fbodin.ac.th%2Fhome%2Fcategory%2Fnewstudent-2569"><span class="ref-00002">การเข้าศึกษาต่อโรงเรียนบดินทรเดชา (สิงห์ สิงหเสนี) ในปีการศึกษา</span> <?=$admission["year"]?></a> <span class="ref-00003">ได้ที่นี่</span></p>
		<div class="wrapper">
		...
		<ul class="announcements-list">
			...
			<li data-release="02-06"><a target="_blank" href="<?=$admission["link"]?>2%2F37454">ผลการจัด<b>กลุ่มการเรียน</b>นักเรียนชั้นมัธยมศึกษาปีที่ 3 ที่มีสิทธิ์เข้าเรียนต่อชั้นมัธยมศึกษาปีที่ <b>4</b> [รอบที่ <b>1</b>]</a></li>
		</ul>
		...
		<ul class="announcements-list">
			...
			<li>
				...
				<a data-release="01-28" target="_blank" href="<?=$admission["link"]?>1%2F37234">[รอบที่ <b>1</b>]</a>
				<a data-release="01-30" target="_blank" href="<?=$admission["link"]?>1%2F37283">[รอบที่ <b>2</b>]</a>
				<a data-release="02-03" target="_blank" href="<?=$admission["link"]?>2%2F37395">[รอบที่ <b>3</b>]</a>
