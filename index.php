		...
		<main shrink="<?php echo($_COOKIE['sui_open-nt'])??"false"; ?>">
			<div class="container">
				...
				<ul>
					...
					<li disabled data-release="10"><a target="_blank" href="<?=$ann_link?>2____">นักเรียนที่ผ่านการคัดเลือกเข้าเรียน<b>ห้องเรียนพิเศษ</b>ชั้นมัธยมศึกษาปีที่ <b>1</b></a></li>
					...
					<li data-release="8"><a target="_blank" href="<?=$ann_link?>24314">ผลการจัดกลุ่มการเรียนนักเรียนชั้นมัธยมศึกษาปีที่ 4 ปีการศึกษา 2565 ประเภทห้องเรียนปกติ จากนักเรียนที่จบชั้นมัธยมศึกษาปีที่ 3 จากโรงเรียนเดิม</a></li>
				</ul>
			</div>
		</main>
