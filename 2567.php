		...
		<app name="main">
			...
			<main class="bg-rainbow-img">
				<section class="container">
					...
					<p><span class="ref-00001">ติดตามข่าว</span><a target="_blank" href="/go?url=https%3A%2F%2Fbodin.ac.th%2Fhome%2Fcategory%2F___"><span class="ref-00002">การเข้าศึกษาต่อโรงเรียนบดินทรเดชา (สิงห์ สิงหเสนี) ในปีการศึกษา</span> <?=$admission["year"]?></a> <span class="ref-00003">ได้ที่นี่</span></p>
					<div class="wrapper">
						<div class="card message purple">
							...
							<div class="action">
								<a disabled href="new" role="button"><span class="text">ดำเนินการ</span></a>
							</div>
						</div>
						<div class="card message blue">
							...
							<div class="action">
								<a disabled <?=isset($_SESSION["auth"]) ? 'href="M4/"' : 'onClick="sys.auth.orize(\'e%2Fenroll%2FM4%2F\')" href="javascript:"'?> role="button"><span class="text">ดำเนินการ</span></a>
							</div>
						</div>
					</div>
					...
					<ul>
						...
						<li disabled data-release="__-__"><a target="_blank" href="<?=$admission["link"]?>_%2F_____">ประเภท<b>ห้องเรียนพสวท. (สู่ความเป็นเลิศ)</b> ชั้นมัธยมศึกษาปีที่ <b>4</b></a></li>
